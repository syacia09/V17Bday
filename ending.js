var w = (c.width = window.innerWidth),
  ...
  calc = {
    // recalculate based on the longest of all three strings
...
function anim() {
  ...
  if (done) {
    // Hanya redirect sekali saja
    if (!window.redirected) {
      window.redirected = true;

      setTimeout(() => {
        window.location.href = "kue.html";
      }, 3000); // tunggu 3 detik biar bisa lihat akhir animasi
    }
  }
}
